    ...
    <div class="container-fluid">
        ...
        <div class="wrapper">
            <div class="login-box">
                ...
                <form method="post" action="./processing-signup" id="login-form" name="login-form" enctype="multipart/form-data" autocomplete="off" novalidate>
                    <div class="form-box">
                        <label for="User name">Full name</label>
                        <input form="login-form" type="text" name="txtFullName" class="form-control" required placeholder="Enter name" id="loginForm">
                    </div>
                    <div class="form-box">
                        <label for="User email">Email</label>
                        <input form="login-form" type="email" name="txtEmail" class="form-control" required placeholder="Enter email" id="loginForm">
                    </div>
                    <div class="form-box">
                    ...
                    <div class="form-box">
                        <input form="login-form" type="submit" id="btnLogin" name="btnSignup" value="Signup" class="btn btn-primary">
                    </div>
                    <div class="form-box">
                        <span><a style="color:#000;" href="./index">Already have an account?</a></span>
                    </div>
                </form>
            </div>
