        ...
        <div class="wrapper">
            <div class="login-box">
                ...
                if (isset($_SESSION['error'])) {
                    echo "<div id='popupAlert' class='alert alert-danger'>" . $_SESSION['error'] . "</div>";
                ...
                <form method="post" action="./index" id="login-form" name="login-form" enctype="multipart/form-data" autocomplete="off" novalidate>
                    <div class="form-box">
                    ...
                    <div class="form-box">
                        <input form="login-form" type="submit" id="btnLogin" name="btnLogin" value="Login" class="btn btn-primary">
                    </div>
                    <div class="form-box">
