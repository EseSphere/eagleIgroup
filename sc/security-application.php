...
<div class="container-fluid page-header py-5">
    <div class="container py-5">
        <h1 class="display-3 text-white mb-3 animated slideInDown">Join Security Team</h1>
        ...
        <div class="row service-row">
            <div class="col-md-6 col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="service-item border h-100 p-5">
                    ...
                    <p>Please complete the form below to apply for a position in our security team. Kindly ensure that your CV is attached.</p>
                    <p>We value professionalism, integrity, and dedication. Qualified applicants will be contacted for the next stage of the recruitment process.</p>
                    <hr>
                    <form action="./submit_security_application" method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-6 col-sm-6 mt-3">
                                <div class="form-group">
                                    <input type="text" id="appForm" name="siaNumber" required class="form-control" placeholder="SIA License Number">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6 col-xl-6 col-sm-6 mt-3">
                                <div class="form-group">
            ...
            <div class="col-md-6 col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <img src="./img/store.jpg" style="width: 100%; height:100%;" alt="">
            </div>
        </div>
    </div>
</div>
