...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 px-4 px-lg-5">
        <a href="./" class="navbar-brand d-flex align-items-center">
            <h2 class="m-0 text-primary">Eagle I Group</h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-4 py-lg-0">
                ...
                <a href="./security" class="nav-item nav-link">Security</a>
                <a href="./cleaning" class="nav-item nav-link">Cleaning</a>
                <a href="./blog" class="nav-item nav-link">Blog</a>
                <a href="./apply-for-job" class="nav-item nav-link">Apply For Jobs</a>
                <a href="./contact" class="nav-item nav-link">Contact Us</a>
                <!--<div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">About Us</a>
                    <div class="dropdown-menu rounded-0 rounded-bottom m-0">
                        <a href="./security" class="dropdown-item">Security</a>
                        <a href="./cleaning" class="dropdown-item">Cleaning</a>
                    </div>
                </div>-->
            </div>
